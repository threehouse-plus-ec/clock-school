  ...
  return (
    <div>
      ...
      <button onClick={save} style={{
        ...
        background: C.amber, color: C.panel, border: "none", borderRadius: 4, cursor: "pointer",
      }}>
        Save Observation
      </button>
  ...
  return (
    <div style={{ marginTop: 16, padding: 14, background: C.blueLight, border: `1px solid ${C.panelBorder}`, borderRadius: 6 }}>
      ...
      <select
        ...
        style={{ width: "100%", padding: "6px 8px", fontSize: 13, border: `1px solid ${C.panelBorder}`, borderRadius: 4, background: C.panel }}
      >
...
export default function SkyCompanion() {
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", fontFamily: "'Crimson Pro', Georgia, serif", color: C.text }}>
      {/* Nav */}
      <div style={{ background: C.panel, borderBottom: `1px solid ${C.panelBorder}`, padding: "6px 20px", display: "flex", gap: 16, fontSize: 11, fontFamily: "'IBM Plex Mono', monospace" }}>
      ...
      <div style={{ background: C.bg, borderBottom: `1px solid ${C.panelBorder}`, padding: "6px 20px", fontSize: 10, color: C.textDim, fontFamily: "'IBM Plex Mono', monospace", lineHeight: 1.5 }}>
        Endorsement Marker: Local candidate framework under local stewardship. Sky predictions here are educational approximations, not precision ephemerides.
      </div>

      {/* Header */}
      <div style={{ background: C.slate900, color: C.text, padding: "16px 20px", borderBottom: `1px solid ${C.panelBorder}` }}>
      ...
      <div style={{ background: C.surface, borderBottom: `1px solid ${C.panelBorder}`, padding: "10px 20px" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          <select
            ...
            style={{ padding: "5px 8px", fontSize: 13, border: `1px solid ${C.panelBorder}`, borderRadius: 4, background: C.panel }}
          >
